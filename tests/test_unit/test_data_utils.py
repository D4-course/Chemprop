...
@patch(
    ...
    lambda *args, **kwargs: ['column0', 'column1']
)
...
class TestGetData(TestCase):
    ...
    def test_2features(self):
        ...
        print(data.features())
        self.assertTrue(np.array_equal(data.features(), [
    ...
    def test_phase_features(self):
        ...
        self.assertTrue(np.array_equal(
            data.phase_features(), [[0, 1], [1, 0], [1, 0]]))
    ...
    def test_features_and_phase_features_2(self):
        """Testing the handling of phase features"""
        with self.assertRaises(ValueError):
            data = get_data(
                path=self.data_path,
...
class TestSplitData(TestCase):
    ...
    def test_split_4_4_2(self):
        ...
        self.assertEqual(train.smiles(), [['CO', 'CCO'], [
                         'CO', 'CCCO'], ['CC', 'CCC'], ['CCCN', 'CCCCN']])
