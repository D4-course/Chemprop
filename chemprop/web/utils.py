...
def set_root_folder(app: Flask, root_folder: str = None,
                    create_folders: bool = True) -> None:
    """
    ...
    if root_folder is not None:
        ...
        app.config['TEMP_FOLDER'] = os.path.join(
            app.config['ROOT_FOLDER'], 'app/temp')
    ...
    if create_folders:
        ...
        for folder_name in ['ROOT_FOLDER', 'DATA_FOLDER',
                            'CHECKPOINT_FOLDER', 'TEMP_FOLDER']:
