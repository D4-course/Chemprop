...
def predict_and_save(
    ...
    if save_results:
        ...
        for full_index, datapoint in enumerate(full_data):
            ...
            # Reshape multiclass to merge task and class dimension, with
            # updated num_tasks
            if args.dataset_type == "multiclass":
...
def make_predictions(
    ...
    # Note: to get the invalid SMILES for your data, use the
    # get_invalid_smiles_from_file or get_invalid_smiles_from_list functions
    # from data/utils.py
