        ...
        if args.loss_function == "mcc" and args.dataset_type == "classification":
            ...
            if args.loss_function == "dirichlet":
                loss = loss_func(
                    preds,
                    targets,
                    args.evidential_regularization) * target_weights * data_weights * mask
            else:
                target_losses = []
                for target_index in range(preds.size(1)):
                ...
                loss = torch.cat(target_losses, dim=1).to(
                    torch_device) * target_weights * data_weights * mask
            ...
            loss = loss_func(
                ...
                targets,
                lt_target_batch,
                gt_target_batch) * target_weights * data_weights * mask
